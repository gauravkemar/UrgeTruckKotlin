...
import com.example.urgetruckkotlin.view.TrackVehicleActivity;
...
public class RFIDHandlerForTrackVehical implements Readers.RFIDReaderEventHandler {
    ...
    // UI and context
    TextView textView;
    private TrackVehicleActivity context;
    ...
    public void init(TrackVehicleActivity activity) {
        // application context
        context = activity;
        // Status UI
