...
import com.example.urgetruckkotlin.view.ExitClearanceNewActivity;
...
public class RFIDHandlerForExiteClearance implements Readers.RFIDReaderEventHandler {
    ...
    // UI and context
    TextView textView;
    private ExitClearanceNewActivity context;
    ...
    public void init(ExitClearanceNewActivity activity) {
        // application context
        context = activity;
        // Status UI
