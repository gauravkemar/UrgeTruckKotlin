...
public class RFIDHandlerForVehiclemapping implements Readers.RFIDReaderEventHandler {
    ...
    // UI and context
    TextView textView;
    private VehicalRifdMappingActivity context;
    ...
    public void init(VehicalRifdMappingActivity activity) {
        // application context
        context = activity;
        // Status UI
