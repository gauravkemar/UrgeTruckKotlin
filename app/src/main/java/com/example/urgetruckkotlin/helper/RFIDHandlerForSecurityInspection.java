...
import com.example.urgetruckkotlin.view.SecurityInspectionActivity;
import com.example.urgetruckkotlin.view.VehicalRifdMappingActivity;
...
public class RFIDHandlerForSecurityInspection implements Readers.RFIDReaderEventHandler {
    ...
    // UI and context
    TextView textView;
    private SecurityInspectionActivity context;
    ...
    public void init(SecurityInspectionActivity activity) {
        // application context
        context = activity;
        // Status UI
